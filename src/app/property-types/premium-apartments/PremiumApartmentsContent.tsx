...
export default function PremiumApartmentsContent() {
  return (
            ...
            {[
              {
                ...
                description: "Floor-to-ceiling windows with contemporary finishes and open-plan layouts maximizing natural light"
              },
              {
                icon: Shield,
                title: "24/7 Security",
                description: "Advanced security systems with concierge services and secure access control for peace of mind"
              },
              {
                icon: Dumbbell,
                title: "Fitness & Wellness",
                description: "State-of-the-art gyms with yoga studios, swimming pools and dedicated wellness facilities"
              },
              {
                icon: UtensilsCrossed,
                title: "Dining Options",
                description: "Access to rooftop restaurants and caf├®s with proximity to Dubai's finest dining"
              },
              {
                icon: MapPin,
                title: "Prime Connectivity",
                description: "Walking distance to metro stations with major highways and key business districts"
              },
              {
                icon: TrendingUp,
                title: "Strong ROI",
                description: "Proven rental yields with capital appreciation in Dubai's thriving real estate market"
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
