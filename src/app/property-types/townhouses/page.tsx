  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden">
        ...
        >
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1600585154526-990dced4db0d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-background p-6 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  On-site retail centers with supermarkets, cafés, restaurants, and essential services. Many 
