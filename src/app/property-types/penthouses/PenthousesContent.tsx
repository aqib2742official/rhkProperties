...
import penthouseFeature1 from "@/assets/images/penthouse-feature-1.jpg";
import penthouseFeature2 from "@/assets/images/penthouse-feature-2.jpg";
import penthouseFeature3 from "@/assets/images/penthouse-feature-3.jpg";

export default function PenthousesContent() {
  return (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {[
              ...
              },
              {
                ...
                description: "Private cinema rooms, wine cellers, bars, and entertainment lounges"
              },
              {
                icon: Sparkles,
